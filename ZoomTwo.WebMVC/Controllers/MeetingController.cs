...
using ZoomTwo.Services;

namespace ZoomTwo.WebMVC.Controllers
{
    public class MeetingController : Controller
    {
        ...
        public ActionResult Edit(int id)
        {
            ...
            ViewBag.OrganizationId = Organizations.Select(o => new SelectListItem()
            {
                Value = o.Id.ToString(),
                Text = o.Name,
                Selected = meeting.OrganizationId == o.Id
            });
            /*
            var query = from o in Organizations
                        select new SelectListItem()
        ...
        public ActionResult Edit(int id, MeetingEdit model)
        {
            ...
            ModelState.AddModelError("", "Something went wrong - could not edit meeting");
            return View(model);
        }
